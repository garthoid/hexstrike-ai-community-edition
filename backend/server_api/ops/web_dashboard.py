...
from backend.server_core.singletons import cache, telemetry, enhanced_process_manager, llm_client
import backend.server_api.ops.system_monitoring as _sm
from backend.server_api.ops.system_monitoring import _get_tool_availability, _get_plugin_install_hints
from backend.server_core.tool_constants import HEALTH_TOOL_CATEGORIES
import json
