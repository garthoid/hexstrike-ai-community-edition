...
from backend.server_core.singletons import session_store
from backend.server_core.session_store import _VALID_NOTE_NAME, _VALID_FOLDER_NAME, NOTE_MAX_BYTES
from backend.server_core.session_flow import append_event
...
def _session_exists(session_id: str) -> bool:
  ...
  from backend.server_core.session_flow import load_session_any
